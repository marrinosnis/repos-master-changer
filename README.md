...
| --commit             | ./gitReposEditor.sh --commit             | Prompt the user to first enter the commit message and then set the manually the paths of the projects where this command will be applied.<br> If no paths are given it will be applied to all the matching pattern folders.  ( [Commit example](#commit-example) )                                                               |
| --push               | ./gitReposEditor.sh --push               | Pushes the committed changes to all the previous specified repositories ( [Push example](#push-example) )                                                                                                                                                                                                                        |
